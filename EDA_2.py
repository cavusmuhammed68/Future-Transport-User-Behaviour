...
plt.savefig('pairplot.png', dpi=300)  # Reduced DPI for pairplot to avoid large image size issue
plt.show()
...
plt.savefig('heatmap_correlation_matrix.png', dpi=1200, bbox_inches='tight')
plt.show()

# Histograms of all numerical features
data[numeric_cols].hist(bins=30, figsize=(20, 15), edgecolor='black')
plt.suptitle('Histograms of Numerical Features')
plt.savefig('histograms_numerical_features.png', dpi=1200)
plt.show()
...
plt.savefig('boxplots_numerical_features.png', dpi=1200)
plt.show()
...
plt.savefig('distribution_charging_costs.png', dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.savefig('distribution_energy_consumption.png', dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.savefig('distribution_charging_duration.png', dpi=1200)
plt.show()
